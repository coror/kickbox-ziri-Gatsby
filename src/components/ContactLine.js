...
const ContactLine = () => {
  return (
    <div className='flex-col md:flex-row bg-layout2 flex text-text1 py-10 font-oswald space-y-5'>
      {/* Phone */}
      <div className='text-center flex-1 relative' style={{ display: 'grid' }}>
        ...
        >
          <div className='text-center'>
            <p className=' text-identifier text-lg font-semibold'>POKLIČITE NAS NA</p>
      ...
      <div className='text-center flex-1 relative' style={{ display: 'grid' }}>
        ...
        >
          <div className='special-heading text-center'>
            <p className='text-identifier text-lg font-semibold'>DELOVNE URE</p>
