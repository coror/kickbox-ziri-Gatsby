...
const Urnik = () => {
  ...
  return (
    <div className='text-text1 font-oswald text-center relative pb-10'>
      ...
      >
        <div
          className={`flex flex-col items-center justify-center mb-10 py-10  ${
            animate
        ...
        <div
          className='flex justify-center items-center  text-xs md:text-base overflow-x-auto'
          ref={ref}
        >
          <table
            className={`m-10 border-2 border-collapse ${
              animate
                ? 'animate-fade-right animate-once animate-duration-1000 animate-delay-200'
                : ''
            }`}
          >
            <thead>
            ...
            <tbody>
              ...
              <tr>
                <td className='p-2 border-2'>17:30</td>
              </tr>
              <tr>
              ...
              <tr>
                <td className='p-2 border-2'>18:30</td>
              </tr>
              <tr>
                <td className='p-2 border-2'>19:00</td>
              </tr>
              <tr>
