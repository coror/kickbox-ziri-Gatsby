          ...
          >
            <div className='flex flex-col xl:flex-row items-center xl:items-start justify-center'>
              ...
              <p className=' max-w-[50rem] md:text-lg md:mx-10  text-center animate-fade-right animate-duration-1000 animate-delay-2000'>
                ...
                del Inštituta borilnih veščin (prej Karate inštituta). Inštitut
                je, s preko 400 aktivnimi člani, eno največjih slovenskih
                združenj borilnih športov in veščin. V njem na osnovi bogatih
                izkušenj iz borbenih znanj, inovativnega znanstvenega
                raziskovanja, več desetletnega pedagoškega in andragoškega dela,
                oblikujemo moderne vadbene programe borilnih veščin, s poudarkom
                na karateju in kikboksu, ki so prilagojeni potrebam modernega
                časa, starosti in željam vsakega posameznika. Trudimo se, da
                redna vadba naših programov pripomore k bolj polnemu in
                kvalitetnemu življenju in vadečim omogoča, da se postopno
                približujejo glavnim idealom borilnih veščin, vzpostavitvi
                notranje sproščenosti, umirjenosti, odločnosti in zdravega
                borbenega duha.
              </p>
            </div>
            <div className='flex flex-col xl:flex-row-reverse items-center xl:items-start justify-center mt-10'>
              ...
              <p className=' max-w-[50rem] md:text-lg md:mx-10  text-center animate-fade-right animate-duration-1000 animate-delay-2000'>
                ...
                sekcije v Idriji, ki ima že več kot 20 letno tradicijo. S
                treningi kikboksa smo v Idriji začeli že leta 2002. Prvi trener
                je bil Miha Božič, ki je bil v tistem obdobju državni prvak v
                karateju in kikboksu. Leta 2018 je vodenje kikboks skupin
                prevzel Erin Ćoralić. Kikboks program smo pod njegovim vodstvom
                prenovili, dodali več prvin boksa in tajskega boksa ter
                pripravili posebne programe kikboksa za mladostnike. V Žireh
                trenutno delujejo tri kikboks skupine. Začetna in nadaljevalna
                kikboks skupina za odrasle ter skupina kikboksa za mladostnike,
                aktivno pa se treningov udeležuje preko 30 vadečih.
              </p>
            </div>
          </div>
          {/* POMEN */}
