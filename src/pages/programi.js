              ...
              <div className='flex 2xl:flex-row flex-col'>
                ...
                <div className='md:mt-10 flex flex-col items-center 2xl:block  animate-fade-right animate-duration-1000 animate-delay-1000'>
                  <p className='max-w-[50rem] md:text-lg md:mx-10 text-center'>
                    Čeprav je kikboks kontaktni borilni šport je predsodek, da
                    gre za agresiven ali nasilen šport, ki ni primeren za
                    mladostnike, odveč. Program je prilagojen mladostnikom od
                    12. do 16. leta. Vadba se izvaja v nadzorovanem okolju, z
                    ustrezno zaščitno opremo. Vadeči se postopno privajajo na
                    rahle kontakte, kar jim lahko pomaga, da premagujejo strah,
                    gradijo samozavest in se tudi učijo nadzorovati lastno
                    agresijo. Z izvajanjem tehnik na različne tarče (fokusarje)
                    razvijajo natančnost in moč, v dogovorjenih borbah pa se na
                    varen način srečujejo z borbenimi situacijami. Kikboks je
                    zelo dinamičen, zanimiv, socialen, raznolik in tudi fizično
                    naporen šport, ki lahko mladostnike ustrezno nagovori tudi v
                    njihovi najstniški fazi.
                  </p>
                  <p className='max-w-[50rem] md:text-lg md:mx-10 text-center mt-10'>
                    ...
                    klubu in v šoli dodatno motiviramo s pomočjo motivacijske
                    igre Joker, ki digitalno okolje uporablja za motiviranje
                    vadečih pri doseganju boljših rezultatov v šoli in pri
                    kikboksu. Jokerja je mogoče osvojiti z dobrimi ocenami v
                    šoli, dobrimi rezultati na testiranju gibalnih sposobnosti
                    ali s pomočjo na treningih in tekmovanjih. Kikboks je
                    dinamičen in energičen šport, ki prinaša številne koristi za
                    razvoj mladostnikov. Vabimo vas, da se nam pridružite. Z
                    veseljem bomo z vami delili naše znanje, izkušnje in
                    navdušenje nad tem zanimivim borilnim športom.
                  </p>
                    ...
                    <div className='text-center max-w-[40rem] pt-10'>
                      ...
                      <ul>
                        ...
                        <p className='mb-5 md:text-lg'>
                          Vadba kikboksa je odličen način za krepitev
                          samozavesti pri mladostnikih. Učenje borbenih
                          elementov, delo v paru, zaupanje partnerju, privajanje
                          na rahle kontakte ima pozitiven učinek na
                          mladostnikovo soočanje s strahom, stresnimi
                          situacijami in pomaga pri krepitvi odločnosti in
                          pozornosti.
                        </p>
                        ...
                        <p className='mb-5 md:text-lg'>
                          ...
                          pomenu spoštovanja, discipline, urejenosti,
                          sodelovanja in ekipnega dela. To prispeva k razvoju
                          socialnih veščin, ki so pomembne za uspešne
                        ...
                        <p className='mb-5 md:text-lg'>
                          ...
                          ključne veščine, ki jim bodo koristile v šoli, doma in
                          v življenju.
                        </p>
                      </ul>
                    </div>
                ...
                <div className='flex 2xl:flex-row flex-col'>
                  ...
                  <div className='md:mt-10 flex flex-col items-center 2xl:block  animate-fade-right animate-duration-1000 animate-delay-1000'>
                    <p className='max-w-[50rem] md:text-lg md:mx-10 text-center'>
                      ...
                      koordinacijo. Šport je z borbenega vidika zelo praktičen
                      in uporaben. V kontroliranem, dogovorjenem okolju se
                      srečujemo z različnimi razsežnostmi borbe in se učimo
                      samoobrambe, premagovanja strahu, treme in krepitve
                      koncentracije v stresnih situacijah. Kikboks je primeren
                      za vse ne glede na spol. Naši tečaji so zasnovani tako, da
                      omogočajo udobno in varno okolje za vadbo tako ženskam kot
                      moškim. Prilagoditve se lahko naredijo glede na
                      posameznikove potrebe. Pridružite se nam in dovolite, da
                      kickbox postane del vašega življenja! Ne glede na to, ali
                      iščete kondicijski izziv, sredstvo za sprostitev ali novo
                      skupnost, boste pri nas našli vse to in še več. Kikboks je
                      šport, ki ne pozna starostnih omejitev in prinaša številne
                      koristi za vsakogar, ne glede na spol.
                    </p>
                    <div className='flex flex-col md:flex-row items-center justify-center'>
                      <div className='text-center max-w-[40rem] pt-10'>
                        <div className='text-xl mb-7 underline'>
                        ...
                        <ul>
                          ...
                          <p className='mb-5 md:text-lg'>
                            Naš program je primeren tako za popolne začetnike
                            kot tudi za tiste, ki že imajo nekaj izkušenj s
                            kikboksom. Program je prilagojen različnim ravnem
                            znanja, zato boste lahko uživali v vadbi, ne glede
                            na to, ali ste novinec ali izkušen borec.
                          </p>
                          <li className='mb-5 text-lg font-semibold md:text-lg'>
                          ...
                          <p className='mb-5 md:text-lg'>
                            ...
                            celotno telo, ki združuje kardio trening, vadbo za
                            moč in fleksibilnost. S tem boste krepili mišice,
                            izboljšali vzdržljivost in poskrbeli za svoje
                            splošno zdravje.
                          </p>
                          <li className='mb-5 text-lg font-semibold'>
                          ...
                          <p className='mb-5 md:text-lg'>
                            Aktivna vadba kikboksa je odličen način sprostitve
                            in zmanjšanja stresa. Ob energični vadbi boste
                            pozabili na vsakodnevne skrbi, hkrati pa boste
                            vadili svoje telo in duha.
                          </p>
                          ...
                          <p className='mb-5 md:text-lg'>
                            Naše kikboks skupine ponujajo priložnost za
                            sklepanje novih prijateljstev. Ne glede na vaše
                            znanje boste deležni spodbude in motivacije, saj
                          ...
                          <p className='mb-5 md:text-lg'>
                            ...
                            okolje za vadbo tako ženskam kot moškim.
                            Prilagoditve se lahko naredijo glede na
