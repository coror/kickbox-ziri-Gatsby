            ...
            <div className='flex md:flex-row flex-col max-w-[60rem] items-center xl:items-start'>
              ...
              <div className=' text-text1    animate-fade-right animate-duration-1000 animate-delay-1000'>
                ...
                <p className=' md:text-lg'>
                  ...
                  karatejem se je začel ukvarjati pri šestih letih. Udeleževal
                  se je številnih državnih in mednarodnih tekmovanj, kjer je bil
                  zelo uspešen. V sklopu državnih tekmovanj je večkrat osvojil
                  zlato. V srednji šoli je začel trenirati kickboks, v
                  študentskih letih pa Muay Thai (tajski boks). Po vrnitvi v
                  Idrijo je njegova pot ostala tesno prepletena z borilnimi
                  veščinami, tokrat v drugačni vlogi. Leta 2018 je začel voditi
                  treninge kickboksa, naslednje leto pa je z opravljenim
                  usposabljanjem za vaditelja karateja, začel delovati tudi kot
                  trener karateja. Trenutno je trener kickboksa v Idriji in v
                  Žireh ter karate trener tekmovalcev ter rekreativnih skupin v
                  Idriji, Črnem Vrhu, Spodnji Idriji in Žireh. Poleg tega je
                  reprezentančni trener Karate zveze Slovenije, kjer svoje
                  bogate izkušnje in znanje prenaša tudi na vrhunske športnike.
                </p>
              </div>
            </div>
            ...
            <div className='flex md:flex-row flex-col max-w-[60rem] mt-20 items-center xl:items-start'>
              ...
              <div className=' text-text1    animate-fade-right animate-duration-1000 animate-delay-1000'>
                ...
                <p className=' md:text-lg'>
                  ...
                  katero je treniral do trinajstega leta. Nadaljeval je s
                  košarko vse do drugega letnika srednje šole. Po vseh teh letih
                  ...
                  pomočnik trenerja pomagal pri treningih. Sedaj pa kot trener
                  že tri leta poučuje začetne skupine. Delo z otroki in
                  mladostniki mu ne predstavlja nobenih težav ali povzroča
                  stresa, saj je velikokrat pomagal oziroma bil animator na
                  različnih dogodkih.
                </p>
              </div>
            </div>
